...
const SignUpForm = (props) => {
    const { userJWT, handleSignUpAndSaveUserJWT, errorSignInAndSignUp } = useContext(GlobalContext);
    ...
    const handleSubmit = (e) => {
        ...
        handleSignUpAndSaveUserJWT(username, password);
    }
    ...
    return (
        <div className={styles.form_container}>
            <form className={styles.form}>      
                ...
                <button onClick={handleSubmit} className={styles.btn_submit}>S'inscrire</button>
            </form>
        </div>
    );
};
